...
'@commercetools-uikit/inline': patch
'@commercetools-uikit/inset': patch
'@commercetools-uikit/inset-squish': patch
'@commercetools-uikit/stack': patch
...
Ensure each package.json of each package has all the necessary fields.
