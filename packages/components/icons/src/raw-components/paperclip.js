...
function Paperclip(props) {
  return (
    <svg
      ...
      {...props}
    >
      <g id="paperclip__Icons">
        <g id="paperclip__MC-icon-set" transform="translate(-24 -1307)">
          <g id="paperclip__paperclip" transform="translate(24 1307)">
            <path
              id="paperclip__shape"
