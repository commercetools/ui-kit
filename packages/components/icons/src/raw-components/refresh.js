...
function Refresh(props) {
  return (
    <svg
      ...
      {...props}
    >
      <g id="refresh__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
        <g
          id="refresh__MC-icon-set"
          transform="translate(-168 -984)"
          fillRule="nonzero"
          fill="#000"
        >
          <g id="refresh__Directions" transform="translate(24 888)">
            <g id="refresh__Refresh" transform="translate(144 96)">
              <path
