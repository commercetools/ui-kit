...
function Pages(props) {
  return (
    <svg
      ...
      {...props}
    >
      <g id="pages__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
        <g id="pages__MC-icon-set" transform="translate(-24 -264)">
          <g id="pages__Menu" transform="translate(24 168)">
            <g id="pages__Pages" transform="translate(0 96)">
              <path
