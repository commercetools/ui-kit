...
function ChainBroken(props) {
  return (
    ...
    >
      <g
        id="chain-broken__Icons"
        stroke="none"
        strokeWidth={1}
        fillRule="evenodd"
      >
        <g
          id="chain-broken__MC-icon-set"
          transform="translate(-168 -504)"
          fill="#000"
        >
          <g id="chain-broken__Images" transform="translate(24 504)">
            <g id="chain-broken__Chain-Broken" transform="translate(144)">
              <path
