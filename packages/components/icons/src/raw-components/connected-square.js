...
function ConnectedSquare(props) {
  return (
    <svg
      id="connected-square__Ebene_1"
      ...
      {...props}
    >
      <g id="connected-square__Icons">
        <g id="connected-square__MC-icon-set" transform="translate(-96 -1306)">
          <g
            id="connected-square__Connected-Square"
            transform="translate(96 1306)"
          >
            <path
              id="connected-square__shape"
