...
function Split(props) {
  return (
    <svg
      ...
      {...props}
    >
      <g id="split__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
        <g id="split__MC-icon-set" transform="translate(-168 -792)" fill="#000">
          <g id="split__Actions" transform="translate(24 648)">
            <g id="split__Split" transform="translate(144 144)">
              <path
