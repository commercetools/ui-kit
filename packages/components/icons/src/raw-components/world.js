...
function World(props) {
  return (
    <svg
      ...
      {...props}
    >
      <g id="world__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
        <g id="world__MC-icon-set" transform="translate(-96 -24)" fill="#000">
          <g id="world__Application" transform="translate(24 24)">
            <g id="world__World" transform="translate(72)">
              <path
