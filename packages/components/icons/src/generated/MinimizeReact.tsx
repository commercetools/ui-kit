...
const SvgMinimize = (props: SVGProps) => (
  ...
  >
    <path
      d="M6.975 21a.926.926 0 0 1-.7-.288A.99.99 0 0 1 6 20c0-.283.096-.52.287-.712A.968.968 0 0 1 7 19h10.025c.283 0 .517.096.7.288A.99.99 0 0 1 18 20c0 .283-.096.52-.288.712A.965.965 0 0 1 17 21H6.975Z"
      fill="#000"
    />
  </svg>
);
