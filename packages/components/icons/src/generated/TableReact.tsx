...
const SvgTable = (props: SVGProps) => (
  ...
  >
    <path
      d="M20.458 4.51a1.676 1.676 0 0 0-1.22-.5H4.728c-.476 0-.882.167-1.22.5A1.628 1.628 0 0 0 3 5.713v12.94c0 .47.17.87.507 1.203.339.334.745.5 1.22.5h14.51c.476 0 .883-.166 1.221-.5.338-.333.507-.734.507-1.202V5.713c0-.468-.169-.87-.507-1.203Zm-9.166 14.484H4.727a.335.335 0 0 1-.242-.1.325.325 0 0 1-.103-.24V6.734h6.91v12.26Zm8.291-.34a.325.325 0 0 1-.102.24.335.335 0 0 1-.243.1h-6.564V6.734h6.91v11.92Z"
      fillRule="evenodd"
    />
  </svg>
);
