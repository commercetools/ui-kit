...
const SvgBinFilled = (props: Props) => <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}><path d="M8.39 4.815v-1.8h7.2v1.8h4.5v2.7H3.89v-2.7h4.5zm9 2.7h.9l-.788 11.82a1.797 1.797 0 01-1.794 1.68H8.272a1.8 1.8 0 01-1.794-1.68L5.69 7.515H17.39zm-4.95 9v-7.2h-.9v7.2h.9zm-2.25 0v-7.2h-.9v7.2h.9zm4.5 0v-7.2h-.9v7.2h.9z" fillRule="evenodd" /></svg>;
