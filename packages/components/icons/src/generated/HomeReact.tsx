...
export const getIconStyles = (props: Props) => css`
  *:not([fill='none']) {
  ...
  flex-shrink: 0;
`;
const SvgHome = ({ titleId, title, ...props }: SVGProps) => (
  <svg
