...
const SvgHome = (props: SVGProps) => (
  ...
  >
    <path
      d="M6.057 18.943h3.086V12.77h6.171v6.172H18.4V9.686l-6.171-4.629-6.172 4.629v9.257Zm0 2.057a1.98 1.98 0 0 1-1.452-.604A1.982 1.982 0 0 1 4 18.943V9.686c0-.326.073-.635.22-.926.144-.291.346-.531.603-.72l6.171-4.629a2.17 2.17 0 0 1 .592-.308A2.02 2.02 0 0 1 12.229 3c.222 0 .437.034.642.103.206.068.403.171.592.308l6.171 4.629a2.047 2.047 0 0 1 .823 1.646v9.257c0 .566-.201 1.05-.604 1.453A1.983 1.983 0 0 1 18.4 21h-5.143v-6.171H11.2V21H6.057Z"
      fill="#1A1A1A"
      fillRule="evenodd"
    />
  </svg>
