...
export const getIconStyles = (props: Props) => css`
  *:not([fill='none']) {
  ...
  flex-shrink: 0;
`;
const SvgChainBroken = ({ titleId, title, ...props }: SVGProps) => (
  <svg
...
const titleSequentialId = createSequentialId('chain-broken-icon-title-');
    ...
    <ClassNames>
      {({ css: createClass }) => (
        <SvgChainBroken
          {...props}
          titleId={svgTitleId}
          title={props.title || 'Chain broken icon'}
