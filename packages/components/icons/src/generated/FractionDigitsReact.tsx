...
export const getIconStyles = (props: Props) => css`
  *:not([fill='none']) {
  ...
  flex-shrink: 0;
`;
const SvgFractionDigits = ({ titleId, title, ...props }: SVGProps) => (
  <svg
...
const titleSequentialId = createSequentialId('fraction-digits-icon-title-');
    ...
    <ClassNames>
      {({ css: createClass }) => (
        <SvgFractionDigits
          {...props}
          titleId={svgTitleId}
          title={props.title || 'Fraction digits icon'}
