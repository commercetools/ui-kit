...
const SvgCaretUp = (props: SVGProps) => (
  ...
  >
    <path
      d="M3.334 17.37c.223.235.486.353.791.353h15.75c.305 0 .568-.118.791-.354a1.18 1.18 0 00.334-.838 1.18 1.18 0 00-.334-.837l-7.875-8.34A1.053 1.053 0 0012 7c-.305 0-.568.118-.791.354l-7.875 8.34A1.18 1.18 0 003 16.53c0 .323.112.602.334.838z"
      fillRule="evenodd"
    />
  </svg>
);
