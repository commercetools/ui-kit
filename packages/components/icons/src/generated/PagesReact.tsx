...
const SvgPages = (props: Props) => <svg width={24} height={24} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}><g id="pages_react_svg__Icons" stroke="none" strokeWidth={1} fillRule="evenodd"><g id="pages_react_svg__MC-icon-set" transform="translate(-24 -264)"><g id="pages_react_svg__Menu" transform="translate(24 168)"><g id="pages_react_svg__Pages" transform="translate(0 96)"><path d="M7.737 18.058a.325.325 0 01-.322-.327V6.253c0-.181.146-.327.322-.327h8.526c.175 0 .32.146.32.327v.746H9.35a.851.851 0 00-.852.851v10.208h-.763zM6.5 6.253v9.813h-.763a.325.325 0 01-.322-.326V4.26c0-.18.146-.327.322-.327h8.526c.175 0 .32.147.32.327v.732H7.736A1.25 1.25 0 006.5 6.253zm12.15.746H17.5v-.746a1.25 1.25 0 00-1.238-1.261H15.5V4.26A1.25 1.25 0 0014.262 3H5.736A1.25 1.25 0 004.5 4.26v11.48c0 .693.554 1.26 1.237 1.26H6.5v.731c0 .696.554 1.26 1.237 1.26h.762v1.158c0 .469.381.85.851.85h9.3a.85.85 0 00.85-.85V7.85a.851.851 0 00-.85-.851z" id="pages_react_svg__shape" /></g></g></g></g></svg>;
