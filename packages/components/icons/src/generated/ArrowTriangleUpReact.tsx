...
export const getIconStyles = (props: Props) => css`
  *:not([fill='none']) {
  ...
  flex-shrink: 0;
`;
const SvgArrowTriangleUp = ({ titleId, title, ...props }: SVGProps) => (
  <svg
...
const titleSequentialId = createSequentialId('arrow-triangle-up-icon-title-');
    ...
    <ClassNames>
      {({ css: createClass }) => (
        <SvgArrowTriangleUp
          {...props}
          titleId={svgTitleId}
          title={props.title || 'Arrow triangle up icon'}
