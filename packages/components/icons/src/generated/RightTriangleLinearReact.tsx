...
const SvgRightTriangleLinear = (props: SVGProps) => (
  <svg
    ...
    {...props}
  >
    <path d="M5.575 20.5h14.9V5.6l-14.9 14.9Zm-1.8 1.5c-.333 0-.563-.154-.688-.462-.125-.309-.07-.58.163-.813L20.7 3.275c.233-.233.504-.287.812-.162.309.125.463.354.463.687v17.45a.729.729 0 0 1-.75.75H3.775Z" />
  </svg>
);
