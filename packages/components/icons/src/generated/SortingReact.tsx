...
const SvgSorting = (props: SVGProps) => (
  ...
  >
    <path
      d="M12.994 17.318 9.554 21l-3.506-3.682h2.686v-5.5a.82.82 0 0 1 1.641 0v5.5h2.62ZM11.006 6.682 14.446 3l3.506 3.682h-2.686v5.5a.82.82 0 0 1-1.641 0v-5.5h-2.62Z"
      fillRule="evenodd"
    />
  </svg>
);
