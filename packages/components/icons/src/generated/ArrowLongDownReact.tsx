...
export const getIconStyles = (props: Props) => css`
  *:not([fill='none']) {
  ...
  flex-shrink: 0;
`;
const SvgArrowLongDown = ({ titleId, title, ...props }: SVGProps) => (
  <svg
...
const titleSequentialId = createSequentialId('arrow-long-down-icon-title-');
    ...
    <ClassNames>
      {({ css: createClass }) => (
        <SvgArrowLongDown
          {...props}
          titleId={svgTitleId}
          title={props.title || 'Arrow long down icon'}
