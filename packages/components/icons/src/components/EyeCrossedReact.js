...
const SvgEyeCrossedreact = (props) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
  ...
  >
    ...
    >
      <g
        id="eye-crossed_react_svg__component-/-icon-/-24px-/-eye-crossed"
        fill="#1A1A1A"
      >
        <g id="eye-crossed_react_svg__icon">
          <path
            ...
            id="eye-crossed_react_svg__shape"
          />
        </g>
      </g>
    </g>
...
SvgEyeCrossedreact.displayName = 'SvgEyeCrossedreact';

const Component = (props) => {
  const theme = useTheme();
  return <SvgEyeCrossedreact {...props} css={getIconStyles(props, theme)} />;
};
