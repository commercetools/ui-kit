...
const SvgConnectedSquarereact = (props) => (
  <svg
...
SvgConnectedSquarereact.displayName = 'SvgConnectedSquarereact';

const Component = (props) => {
  const theme = useTheme();
  return (
    <SvgConnectedSquarereact {...props} css={getIconStyles(props, theme)} />
  );
};
