...
const SvgPaperBillInvertedreact = (props) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
...
SvgPaperBillInvertedreact.displayName = 'SvgPaperBillInvertedreact';

const Component = (props) => {
  const theme = useTheme();
  return (
    <SvgPaperBillInvertedreact {...props} css={getIconStyles(props, theme)} />
  );
};
