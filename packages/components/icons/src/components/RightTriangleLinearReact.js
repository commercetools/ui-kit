...
const SvgRightTriangleLinearreact = (props) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 8 8"
...
SvgRightTriangleLinearreact.displayName = 'SvgRightTriangleLinearreact';

const Component = (props) => {
  const theme = useTheme();
  return (
    <SvgRightTriangleLinearreact {...props} css={getIconStyles(props, theme)} />
  );
};
