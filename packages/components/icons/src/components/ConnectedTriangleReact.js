...
const SvgConnectedTrianglereact = (props) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
...
SvgConnectedTrianglereact.displayName = 'SvgConnectedTrianglereact';

const Component = (props) => {
  const theme = useTheme();
  return (
    <SvgConnectedTrianglereact {...props} css={getIconStyles(props, theme)} />
  );
};
