...
const SvgGraduationCapreact = (props) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
...
SvgGraduationCapreact.displayName = 'SvgGraduationCapreact';

const Component = (props) => {
  const theme = useTheme();
  return <SvgGraduationCapreact {...props} css={getIconStyles(props, theme)} />;
};
