...
const SvgArrowLongDownreact = (props) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
...
SvgArrowLongDownreact.displayName = 'SvgArrowLongDownreact';

const Component = (props) => {
  const theme = useTheme();
  return <SvgArrowLongDownreact {...props} css={getIconStyles(props, theme)} />;
};
