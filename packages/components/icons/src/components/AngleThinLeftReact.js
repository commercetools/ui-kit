...
const SvgAngleThinLeftreact = (props) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
...
SvgAngleThinLeftreact.displayName = 'SvgAngleThinLeftreact';

const Component = (props) => {
  const theme = useTheme();
  return <SvgAngleThinLeftreact {...props} css={getIconStyles(props, theme)} />;
};
