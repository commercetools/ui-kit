...
| `wrapHeaderLabel`      | `boolean` | -        | `true`  | Sets whether the column header labels should be allowed to break in several lines or not. If true, the header may grow in height, otherwise the column will guarantee a larger minimum width, enough to contain the label in one line.                                                                                                                                                                                                                                |
