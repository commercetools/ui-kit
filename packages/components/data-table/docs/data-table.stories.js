...
const Template = (args) => {
  ...
  const onRowClick = args.onRowClick;
    ...
    <div>
      <DataTable
        ...
        maxHeight={castToNumberIfPossible(
          ...
          args.maxHeight || 'max(400px, calc(100vh - 200px))'
        )}
        maxWidth={castToNumberIfPossible(args.maxWidth)}
        sortedBy={sortedBy}
      ...
      <div>
        ...
        <p>
          Note: the <code>width</code> input accepts the same values as the ones
          specified for{' '}
          ...
          of <code>1fr</code> and <code>2fr</code>, or simply fixed values like{' '}
          <code>100px</code>. The default is <code>auto</code>.
        </p>
