...
| `components.BodyComponent`                    | `element`                                                                                                                                                                                          |          | `{}`           | The component rendered as the tooltip body.                                                                                                                                                              |
| `components.TooltipWrapperComponent`          | `element`                                                                                                                                                                                          |          | `{}`           | Where the tooltip should be rendered. This can be useful to render the tooltip into another part of the document, using React portal.                                                                    |
| `components.WrapperComponent`                 | `element`                                                                                                                                                                                          |          | `{}`           | A custom component wrapper for the tooltip.                                                                                                                                                              |
