...
| `closeMenuOnSelect`      | `ReactSelectProps['closeMenuOnSelect']`                                                               |    ✅    |         | When set to false, the select menu will not be closed after an option is selected. By default, it is set to true.&#xA;<br>&#xA;[Props from React select was used](https://react-select.com/props)                                                                                                                                                                           |
