...
| `iconLeft`               | `node`             |    -     | -                            |         | Icon to display on the left of the value, when an option is selected                                                                                                                                                                                                                        |
| `iconRight`              | `node`             |    -     | -                            |         | Icon to display on the right of the value, when an option is selected                                                                                                                                                                                                                        |
