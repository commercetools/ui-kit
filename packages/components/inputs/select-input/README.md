...
| `minWidth`                 | `union`<br/>Possible values:<br/>`number , string`                                                    |          |             | The min width (a number of pixels or a css value string with units) for which the select-input&#xA;is allowed to shrink. If unset, the table will shrink to a default value.                                                                                                                                                                                                             |
| `maxWidth`                 | `union`<br/>Possible values:<br/>`number , string`                                                    |          |             | The max width (a number of pixels or a css value string with units) for which the select-input&#xA;is allowed to grow. If unset, the table will grow horrizontally to fill its parent.                                                                                                                                                                                                   |
