...
| `minMenuWidth`             | `union`<br/>Possible values:<br/>`number , string`                                                    |          |             | The min width (a number of pixels or a css value string with units) for which the select-input menu&#xA;is allowed to shrink. If unset, the menu will shrink to a default value.                                                                                                                                                                                                         |
| `maxMenuWidth`             | `union`<br/>Possible values:<br/>`number , string`                                                    |          |             | The max width (a number of pixels or a css value string with units) for which the select-input menu&#xA;is allowed to grow. If unset, the menu will grow horrizontally to fill its parent.                                                                                                                                                                                               |
