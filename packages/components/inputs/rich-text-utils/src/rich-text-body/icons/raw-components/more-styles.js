    ...
    >
      <defs>
        <path
          ...
          id="more-styles__path-1"
        />
      </defs>
      <g
        id="more-styles__Component-/-icon-/-24px-/-Richtext-/-more-styles"
        stroke="none"
        strokeWidth={1}
        fill="none"
        fillRule="evenodd"
      >
        <g id="more-styles__Component-/-icon-/-16px-/-Richtext-/-Strike-trough">
          <mask id="more-styles__mask-2" fill="#fff">
            <use xlinkHref="#more-styles__path-1" />
          </mask>
          <use
            id="more-styles__Combined-Shape"
            fill="#1A1A1A"
            xlinkHref="#more-styles__path-1"
          />
        </g>
      </g>
    </svg>
