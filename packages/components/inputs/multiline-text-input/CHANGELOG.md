...
- [#2845](https://github.com/commercetools/ui-kit/pull/2845) [`3df5448`](https://github.com/commercetools/ui-kit/commit/3df5448add57a4b83529ac8503bc836f2e7ced9e) Thanks [@ddouglasz](https://github.com/ddouglasz)! - Multiple adjustments introduced to the multiline text input which now allows users to be able to add an action icon button of choice to the top right position of the text area, add the condensed feature to accomodate more text and finally, limit text rows as a way of controlling text area height.
...
* [#1901](https://github.com/commercetools/ui-kit/pull/1901) [`e8bc09e3`](https://github.com/commercetools/ui-kit/commit/e8bc09e36d072c744f9380358b490e120906536b) Thanks [@adnasa](https://github.com/adnasa)! - - Remove type assignment on `useToggleState`.
