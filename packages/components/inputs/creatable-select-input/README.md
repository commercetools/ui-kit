...
| `closeMenuOnSelect`       | `CreatableProps['closeMenuOnSelect']`                                                                 |          | `true`  | When set to false, the select menu will not be closed after an option is selected. By default, it is set to true.                                                                                                                                                                                                                                                                           |
