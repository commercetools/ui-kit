...
const SvgIndeterminatereact = (props) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 16 16"
...
SvgIndeterminatereact.displayName = 'SvgIndeterminatereact';

const Component = (props) => {
  const theme = useTheme();
  return <SvgIndeterminatereact {...props} css={getIconStyles(props, theme)} />;
};
