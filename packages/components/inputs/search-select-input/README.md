...
| `onChange`               | `func`                                                                                    |    ✅    |         | Called with a fake event when value changes.<br /> The event's `target.name` will be the `name` supplied in props. The event's `target.value` will hold the value. The value will be the selected option, or an array of options in case `isMulti` is `true`. <br /> Signature: `(event, action) => void` |
| `onFocus`                | `func`                                                                                    |          |         | Handle focus events on the control                                                                                                                                                                                                                                                                        |
| `onInputChange`          | `func`                                                                                    |          |         | Handle change events on the input<br /> Signature: `(inputValue, action) => void`                                                                                                                                                                                                                         |
...
| `loadingMessage`         | `func`                                                                                    |          |         | The text shown while the options are being loaded                                                                                                                                                                                                                                                         |
...
| `optionType`             | `enum`<br>Possible values:<br>`'single-lined' \| 'brief-detailed' \| 'extended-detailed'` |          |         | The style of the an option in the dropdown menu. It could be single lined option or an option with more and custom info                                                                                                                                                                                   |
