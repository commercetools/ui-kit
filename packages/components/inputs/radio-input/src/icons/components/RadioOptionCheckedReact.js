...
const SvgRadioOptionCheckedreact = (props) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 16 16"
...
SvgRadioOptionCheckedreact.displayName = 'SvgRadioOptionCheckedreact';

const Component = (props) => {
  const theme = useTheme();
  return (
    <SvgRadioOptionCheckedreact {...props} css={getIconStyles(props, theme)} />
  );
};
