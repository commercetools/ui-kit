...
describe('SelectableSearchInput.isEmpty', () => {
  ...
  describe('when called with a filled value', () => {
    it('should return false', () => {
      expect(SelectableSearchInput.isEmpty('a')).toBe(false);
      expect(SelectableSearchInput.isEmpty(' a ')).toBe(false);
    });
  });
});
...
describe('SelectableSearchInput', () => {
  it('should forward data-attributes', () => {
    const { container } = render(
      <SelectableSearchInput {...baseProps} data-foo="bar" />
    );
    expect(container.querySelector('input')).toHaveAttribute('data-foo', 'bar');
  });

  it('should render input with empty value', () => {
    const { container } = render(<SelectableSearchInput {...baseProps} />);
    expect(container.querySelector('input')).toHaveAttribute('type', 'text');
  });

  it('should have an HTML name', () => {
    const { container } = render(
      <SelectableSearchInput {...baseProps} name="foo" />
    );
  ...
  it('should have an HTML autocomplete', () => {
    const { container } = render(
      <SelectableSearchInput autoComplete="off" {...baseProps} />
    );
  ...
  it('should forward the passed value', () => {
    const { container } = render(
      <SelectableSearchInput {...baseProps} value="foo" />
    );
  ...
  it('should have ARIA properties for the readonly state', () => {
    const { container } = render(
      <SelectableSearchInput {...baseProps} isReadOnly />
    );
    expect(container.querySelector('input')).toHaveAttribute(
      'aria-readonly',
      'true'
  ...
  it('should call onFocus when the input is focused', () => {
    ...
    const { container } = render(
      <SelectableSearchInput {...baseProps} onFocus={onFocus} />
    );
  ...
  it('should have focus automatically when isAutofocussed is passed', () => {
    const { container } = render(
      <SelectableSearchInput {...baseProps} isAutofocussed />
    );
    expect(container.querySelector('input')).toHaveFocus();
  });
  ...
  it('should call the passed onSubmit function', () => {
    ...
    const { container } = render(
      <SelectableSearchInput {...baseProps} onSubmit={onSubmit} />
    );
  ...
  it('should call the passed onReset function', () => {
    ...
    const { container } = render(
      <SelectableSearchInput {...baseProps} onReset={onReset} />
    );
