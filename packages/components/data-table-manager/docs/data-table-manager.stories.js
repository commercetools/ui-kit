...
export default {
  title: 'Components/DataTableManager',
...
const Template = (args) => {
  ...
  const withRowSelection = args.withRowSelection;
  const footer = args.footer || 'This is a Footer';
  const topBar = args.topBar || 'This is a Top Bar';
  const showDisplaySettingsConfirmationButtons =
    args.showDisplaySettingsConfirmationButtons;
  const showColumnManagerConfirmationButtons =
    args.showColumnManagerConfirmationButtons;
  ...
  const displaySettings = {
    disableDisplaySettings: args.disableDisplaySettings,
    isCondensed,
    isWrappingText,
  ...
  const columnManager = {
    disableColumnManager: args.disableColumnManager,
