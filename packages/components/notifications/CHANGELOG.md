...
* [`1531d23`](https://github.com/commercetools/ui-kit/commit/1531d2305fdad6e03eac0800c42654b2692fa095) [#1501](https://github.com/commercetools/ui-kit/pull/1501) Thanks [@YahiaElTai](https://github.com/YahiaElTai)! - fix: wrap `intlMessage` prop in a `<div>` to have a block layout instead of flex
