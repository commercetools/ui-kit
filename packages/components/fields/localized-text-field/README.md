...
```
pnpm add @commercetools-uikit/localized-text-field
```
...
| `additionalInfo`                | `TLocalizedTextInputProps['additionalInfo']`                                                 |          |           | An object mapping locales to additional messages to be rendered below each input element.&#xA;Example:&#xA;{&#xA;en: 'Some value',&#xA;es: 'Algún valor',&#xA;}                                                                                                       |
