...
| `defaultDaySelectionTime` | `string`                                                                                     |          |           | The time that will be used by default when a user selects a calendar day for the first time. It must follow the “HH:mm” pattern (eg: 04:30, 13:25, 23:59)                                                                                                             |
