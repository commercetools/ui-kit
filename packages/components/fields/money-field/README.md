...
| `touched`               | `object`                                                             |          |           | Indicates whether the `currencyCode` or `amount` fields were touched.<br /> Errors will only be shown when the field was touched.                                                                                                                                     |
| `touched.amount`        | `bool`                                                               |          |           |                                                                                                                                                                                                                                                                       |
...
| `onChange`              | `func`                                                               |    ✅    |           | Called with the event of the input or dropdown when either the currency or the amount have changed.<br /> Signature: `(event) => void`                                                                                                                                |
