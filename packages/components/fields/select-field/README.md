...
| `components`             | `Object`<br/>[See signature.](#signature-components)                                               |          |           | Map of components to overwrite the default ones, see what components you can override                                                                                                                                                                                                                    |
...
| `onFocus`                | `Function`<br/>[See signature.](#signature-onFocus)                                                |          |           | Handle focus events on the control&#xA;<br />&#xA;Signature: `(event) => void`                                                                                                                                                                                                                           |
| `onInputChange`          | `Function`<br/>[See signature.](#signature-onInputChange)                                          |          |           | Handle change events on the input&#xA;<br />&#xA;Signature: `(newValue, actionMeta) => void`                                                                                                                                                                                                             |
