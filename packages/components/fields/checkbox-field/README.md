...
| `onChange`          | `ChangeEventHandler`                                          |    ✅    |         | Will be triggered whenever an `CheckboxField` is clicked. Called with `event`                                                                                                                                                                                                                                               |
| `isHovered`         | `boolean`                                                     |          |         | Forces CheckboxField to be rendered in a hovered state.&#xA;Needed for cases when hovered appearance should be triggered by the parent component and not the CheckboxField itself.&#xA;CheckboxField is capable of handling it's own hovering without the need to pass this prop.                                           |
| `isDisabled`        | `boolean`                                                     |          | `false` | Disables the CheckboxField                                                                                                                                                                                                                                                                                                  |
| `isReadOnly`        | `boolean`                                                     |          |         | Makes the CheckboxField readonly                                                                                                                                                                                                                                                                                            |
| `hasError`          | `boolean`                                                     |          | `false` | Indicates that the checkbox has an error                                                                                                                                                                                                                                                                                    |
| `children`          | `ReactNode`                                                   |          |         | The descriptive text of the CheckboxField, used as its label.                                                                                                                                                                                                                                                               |
