...
- [#2323](https://github.com/commercetools/ui-kit/pull/2323) [`0a42178c2`](https://github.com/commercetools/ui-kit/commit/0a42178c2c733cf31120fa208db182399887677e) Thanks [@CarlosCortizasCT](https://github.com/CarlosCortizasCT)! - Update `Link` component props typescript definition.
...
- [#1829](https://github.com/commercetools/ui-kit/pull/1829) [`d0fd05c9`](https://github.com/commercetools/ui-kit/commit/d0fd05c986cd88333d22798714a816ca67048dac) Thanks [@adnasa](https://github.com/adnasa)! - Remove deprecated prop `hasUnderline` from `Link`.
  `Link` will have `underline` by default.

### Patch Changes

- [#1843](https://github.com/commercetools/ui-kit/pull/1843) [`2ef147fb`](https://github.com/commercetools/ui-kit/commit/2ef147fbd207d6632f10ad9f859633fe1bdc399b) Thanks [@adnasa](https://github.com/adnasa)! - Convert `Link` to TypeScript.
