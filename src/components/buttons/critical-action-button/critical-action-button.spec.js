...
import CriticalButton from './critical-action-button';
...
describe('rendering', () => {
  describe('button', () => {
    ...
    describe('with data-* props', () => {
      beforeEach(() => {
        props = createProps({
          'data-track-component': 'CriticalButton',
          'data-track-label': 'CriticalButton',
          'data-track-event': 'click',
          'data-test': 'data-test-critical',
        });
        wrapper = shallow(<CriticalButton {...props} />);
      });
      it('should apply given `data-track-component` to button', () => {
        expect(wrapper).toHaveProp('data-track-component', 'CriticalButton');
      });
      ...
      it('should apply given `data-track-label` to button', () => {
        expect(wrapper).toHaveProp('data-track-label', 'CriticalButton');
      });
      it('should apply given `data-test` to button', () => {
        expect(wrapper).toHaveProp('data-test', 'data-test-critical');
      });
    });
