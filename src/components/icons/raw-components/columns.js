...
const Columns = props => (
  <svg width={24} height={24} viewBox="0 0 24 24" {...props}>
    <g id="columns__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
      <g id="columns__MC-icon-set" transform="translate(-168 -600)" fill="#000">
        <g id="columns__Grid-display" transform="translate(24 600)">
          <g id="columns__Columns" transform="translate(144)">
            <path
