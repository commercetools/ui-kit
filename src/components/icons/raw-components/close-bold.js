...
const CloseBold = props => (
  <svg width={24} height={24} viewBox="0 0 24 24" {...props}>
    <g id="close-bold__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
      <g
        id="close-bold__MC-icon-set"
        transform="translate(-168 -648)"
        fillRule="nonzero"
        fill="#000"
      >
        <g id="close-bold__Actions" transform="translate(24 648)">
          <g id="close-bold__Close-Bold" transform="translate(144)">
            <path
