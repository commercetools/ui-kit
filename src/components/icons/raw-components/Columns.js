...
const Columns = props => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
    <g id="prefix__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
      <g id="prefix__MC-icon-set" transform="translate(-168 -600)" fill="#000">
        <g id="prefix__Grid-display" transform="translate(24 600)">
          <g id="prefix__Columns" transform="translate(144)">
            <path
