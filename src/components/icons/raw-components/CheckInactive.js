...
const CheckInactive = props => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
    <g id="prefix__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
      <g id="prefix__MC-icon-set" transform="translate(-24 -360)">
        <g id="prefix__Notices" transform="translate(24 312)">
          <g id="prefix__Check-Inactive" transform="translate(0 48)">
            <path
