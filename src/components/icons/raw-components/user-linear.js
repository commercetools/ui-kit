...
const UserLinear = props => (
  <svg width={24} height={24} viewBox="0 0 24 24" {...props}>
    <g id="user-linear__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
      <g
        id="user-linear__MC-icon-set"
        transform="translate(-24 -216)"
        fillRule="nonzero"
        fill="#000"
      >
        <g id="user-linear__Menu" transform="translate(24 168)">
          <g id="user-linear__User-Linear" transform="translate(0 48)">
            <path
