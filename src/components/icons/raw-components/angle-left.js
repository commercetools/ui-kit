...
const AngleLeft = props => (
  <svg width={24} height={24} viewBox="0 0 24 24" {...props}>
    <g id="angle-left__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
      <g
        id="angle-left__MC-icon-set"
        transform="translate(-24 -888)"
        fill="#000"
      >
        <g id="angle-left__Directions" transform="translate(24 888)">
          <g id="angle-left__Angle-Left">
            <path
