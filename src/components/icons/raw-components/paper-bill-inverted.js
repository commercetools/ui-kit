...
function PaperBillInverted(props) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" {...props}>
      <g
        id="paper-bill-inverted__Icons"
        stroke="none"
        strokeWidth={1}
        fillRule="evenodd"
      >
        <g
          id="paper-bill-inverted__MC-icon-set"
          transform="translate(-24 -408)"
          fill="#000"
        >
          <g
            id="paper-bill-inverted__Switch-states"
            transform="translate(24 408)"
          >
            <g id="paper-bill-inverted__Paper-Bill-Inverted">
              <path
...
export default PaperBillInverted;
