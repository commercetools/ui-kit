...
const TagMulti = props => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
    <g id="prefix__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
      <g id="prefix__MC-icon-set" transform="translate(-168 -216)" fill="#000">
        <g id="prefix__Menu" transform="translate(24 168)">
          <g id="prefix__Tag-Multi" transform="translate(144 48)">
            <path
