...
const AngleDown = props => (
  <svg width={24} height={24} viewBox="0 0 24 24" {...props}>
    <g id="angle-down__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
      <g
        id="angle-down__MC-icon-set"
        transform="translate(-168 -888)"
        fill="#000"
      >
        <g id="angle-down__Directions" transform="translate(24 888)">
          <g id="angle-down__Angle-Down" transform="translate(144)">
            <path
