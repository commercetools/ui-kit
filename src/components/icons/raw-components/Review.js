...
const Review = props => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
    ...
    >
      <g transform="translate(64 380)" id="prefix__Menu">
        <g id="prefix__Review" transform="translate(72 96)">
          <g id="prefix__review24">
            <g id="prefix__Shape" transform="translate(3 3)">
              <path
                ...
                fill="#000105"
              />
              <mask id="prefix__mask-2" fill="#fff">
                <use xlinkHref="#prefix__path-1" />
              </mask>
              <use
                id="prefix__Combined-Shape"
                fill="#000105"
