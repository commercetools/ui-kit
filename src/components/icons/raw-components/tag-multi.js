...
function TagMulti(props) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" {...props}>
      <g id="tag-multi__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
        <g
          id="tag-multi__MC-icon-set"
          transform="translate(-168 -216)"
          fill="#000"
        >
          <g id="tag-multi__Menu" transform="translate(24 168)">
            <g id="tag-multi__Tag-Multi" transform="translate(144 48)">
              <path
