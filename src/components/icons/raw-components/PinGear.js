...
const PinGear = props => (
  <svg width="1em" height="1em" viewBox="0 0 18 18" {...props}>
    ...
    <g
      id="prefix__Table-manager"
      stroke="none"
      strokeWidth={1}
      fill="none"
      fillRule="evenodd"
    >
      <g id="prefix__pin-settings" transform="translate(-3 -3)">
        <g id="prefix__Component-/-icon-/-12px-/-screen-gear--">
          <mask id="prefix__mask-2" fill="#fff">
            <use xlinkHref="#prefix__path-1" />
          </mask>
          <use id="prefix__shape" fill="#1A1A1A" xlinkHref="#prefix__path-1" />
        </g>
        <path
