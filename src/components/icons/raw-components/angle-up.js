...
function AngleUp(props) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" {...props}>
      <g id="angle-up__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
        <g
          id="angle-up__MC-icon-set"
          transform="translate(-240 -888)"
          fill="#000"
        >
          <g id="angle-up__Directions" transform="translate(24 888)">
            <g id="angle-up__Angle-Up" transform="translate(216)">
              <path
