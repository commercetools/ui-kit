...
const ChainBroken = props => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
    <g id="prefix__Icons" stroke="none" strokeWidth={1} fillRule="evenodd">
      <g id="prefix__MC-icon-set" transform="translate(-168 -504)" fill="#000">
        <g id="prefix__Images" transform="translate(24 504)">
          <g id="prefix__Chain-Broken" transform="translate(144)">
            <path
