...
import OrigAddressBillingIcon from './svg/address-billing.react.svg';
import OrigAddressShippingIcon from './svg/address-shipping.react.svg';
...
import OrigArrowGraphDownIcon from './svg/arrow-graph-down.react.svg';
import OrigArrowGraphLeftIcon from './svg/arrow-graph-left.react.svg';
import OrigArrowGraphRightIcon from './svg/arrow-graph-right.react.svg';
import OrigArrowGraphUpIcon from './svg/arrow-graph-up.react.svg';
...
import OrigBoxProductIcon from './svg/box-product.react.svg';
...
import OrigCategoryTreeIcon from './svg/category-tree.react.svg';
...
import OrigCustomViewIcon from './svg/custom-view.react.svg';
import OrigCustomerFilledIcon from './svg/customer-filled.react.svg';
import OrigCustomerIcon from './svg/customer.react.svg';
...
import OrigManageProjectsIcon from './svg/manage-projects.react.svg';
...
import OrigOrganizationsIcon from './svg/organizations.react.svg';
...
import OrigTagDiscountIcon from './svg/tag-discount.react.svg';
...
const ManageProjectsIcon = withThemeProp(withSizeProp(OrigManageProjectsIcon));
...
const OrganizationsIcon = withThemeProp(withSizeProp(OrigOrganizationsIcon));
...
ManageProjectsIcon.displayName = 'ManageProjectsIcon';
