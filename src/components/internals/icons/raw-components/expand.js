...
function Expand(props) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" {...props}>
      <g
        id="expand__Component-/-icon-/-16px-/-Richtext-/-Expand"
        stroke="none"
        strokeWidth={1}
        fill="none"
        fillRule="evenodd"
      >
        <g
          id="expand__Component-/-icon-/-16px-/-Richtext-/-Indent"
          fill="#1A1A1A"
        >
          <g id="expand__full-size-copy-3" transform="translate(3 3)">
            <path
