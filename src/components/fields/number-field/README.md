...
| `required`             | `bool`               |    -     | -                            | `false` | Indicates if the value is required. Shows an the "required asterisk" if so.                                                                                                                                                                                           |
...
| `autoFocus`            | `bool`               |    -     | -                            | -       | Focus the input on initial render                                                                                                                                                                                                                                     |
| `disabled`             | `bool`               |    -     | -                            | `false` | Indicates that the input cannot be modified (e.g not authorised, or changes currently saving).                                                                                                                                                                        |
...
The component further forwards all other attributes to the underlying `input` component.
