...
fs.writeFileSync(
  ...
  prettier.format(printCss(designTokens.default), {
    ...prettierConfig,
    parser: 'css',
  })
);
Object.keys(designTokens).forEach((theme) => {
  fs.writeFileSync(
    path.join(__dirname, `../materials/custom-properties_${theme}.css`),
    prettier.format(
      printCss({
