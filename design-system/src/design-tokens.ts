...
export const themes = {
  default: {
    ...
    fontStyleForRequiredIndicator: 'italic',
  ...
  test: {
    ...
    fontStyleForRequiredIndicator: 'normal',
...
const designTokens = {
  ...
  fontStyleItalic: 'var(--font-style-italic, italic)',
  fontStyleNormal: 'var(--font-style-normal, normal)',
  ...
  fontStyleForRequiredIndicator:
    'var(--font-style-for-required-indicator, italic)',
