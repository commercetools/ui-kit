...
export const themes = {
  default: {
    ...
    colorPrimaryOp90: 'hsl(173deg 100% 35% / 90%)',
    colorPrimaryOp95: 'hsl(173deg 100% 35% / 95%)',
    colorAccent: '#213c45',
    ...
    colorWarningOp90: 'hsl(25deg 89% 50% / 90%)',
    colorWarningOp95: 'hsl(25deg 89% 50% / 95%)',
    colorError: '#e60050',
  ...
  test: {
    ...
    backgroundColorForButtonAsPrimaryWhenActive: 'hsl(173deg 100% 35% / 90%)',
    backgroundColorForButtonAsPrimaryWhenHovered: 'hsl(173deg 100% 35% / 95%)',
    backgroundColorForButtonAsIconAsPrimaryWhenActive:
      'hsl(173deg 100% 35% / 90%)',
    backgroundColorForButtonAsIconAsPrimaryWhenHovered: '#00b39e',
...
const designTokens = {
  ...
  colorPrimaryOp90: 'var(--color-primary-op-90, hsl(173deg 100% 35% / 90%))',
  colorPrimaryOp95: 'var(--color-primary-op-95, hsl(173deg 100% 35% / 95%))',
  ...
  colorWarningOp90: 'var(--color-warning-op-90, hsl(25deg 89% 50% / 90%))',
  colorWarningOp95: 'var(--color-warning-op-95, hsl(25deg 89% 50% / 95%))',
  ...
  lineHeightForTextAsDetail: 'var(--line-height-for-text-as-detail, 1.25rem)',
