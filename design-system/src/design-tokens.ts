...
export const themes = {
  default: {
    ...
    colorPrimaryOp90: 'hsla(173, 100%, 35%, 0.90)',
    colorPrimaryOp95: 'hsla(173, 100%, 35%, 0.95)',
    colorAccent: '#213c45',
    ...
    colorWarningOp90: 'hsla(25, 89%, 50%, 90%)',
    colorWarningOp95: 'hsla(25, 89%, 50%, 95%)',
    colorError: '#e60050',
    colorError95: 'hsl(339.1304347826087, 100%, 95%)',
    colorSolid: '#1a1a1a',
    colorSolid05: 'hsla(0, 0%, 10%, .05)',
    colorSolid10: 'hsla(0, 0%, 10%, .10)',
    colorSurface: '#fff',
    borderRadius1: '1px',
    borderRadius2: '2px',
    borderRadius4: '4px',
...
const designTokens = {
  ...
  colorPrimaryOp90: 'var(--color-primary-op-90, hsla(173, 100%, 35%, 0.90))',
  colorPrimaryOp95: 'var(--color-primary-op-95, hsla(173, 100%, 35%, 0.95))',
  ...
  colorWarningOp90: 'var(--color-warning-op-90, hsla(25, 89%, 50%, 90%))',
  colorWarningOp95: 'var(--color-warning-op-95, hsla(25, 89%, 50%, 95%))',
  ...
  colorSolid05: 'var(--color-solid-05, hsla(0, 0%, 10%, .05))',
  colorSolid10: 'var(--color-solid-10, hsla(0, 0%, 10%, .10))',
