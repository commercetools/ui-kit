...
const designTokens = {
  ...
  fontSizeForTextAsH1: 'var(--font-size-for-text-as-h-1, 1.25rem)',
  ...
  lineHeightForTextAsH1: 'var(--line-height-for-text-as-h-1, 1.75rem)',
  ...
  fontWeightForTextAsH1: 'var(--font-weight-for-text-as-h-1, 500)',
