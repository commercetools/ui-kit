...
You can start the application in development mode with the command `pnpm visual-testing-app:start`.
...
Build the application with `pnpm visual-testing-app:build` and serve the production bundles with `pnpm visual-testing-app:preview`.
