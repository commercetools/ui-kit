...
| `align` | `string` | ✅ | ['left', 'center', 'right'] | - | The horizontal alignment of the table column content | | `label` | `number` | - | - | - | The label of the column that will be shown in the column header |
